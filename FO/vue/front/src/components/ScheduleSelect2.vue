  ...
  <form @submit.prevent="onSubmit">
    <div class="container">
      <div class="sm_inner trv_first" style="text-align:center;">
        <h3 style="padding-top: 5%;"><v-icon>mdi-airplane</v-icon>여정 선택</h3>
        <div
          class="travel_info"
          id="depTravelInfo"
        ...
        <div v-if="!isVisible">
          <p>선택하신 조건에 맞는 예약 가능 항공편이 없습니다.</p>
        </div>
      </div>
      <br />
      <div v-if="isVisible" style="padding-bottom: 50px;">
        <v-btn
          type="submit"
          outlined
          color="info"
...
export default {
  ...
  methods: {
    ...
    Base() {
      ...
      this.$axios.post("/flight/searchdeparture", params).then(res => {
